...
from portfolio.datasets.yahoo_finance.quote import Quote
from portfolio.datasets.yahoo_finance.schemas import AvailableRawColumns
...
class Asset:
    def __init__(
        self,
        ticker: str,
        period: str = TimeFrames.YEAR_1,
        time_frame: str = TimeFrames.DAY_1,
        ...
        self.result: dict[str, list] | None = self.quote.download_quote(
            self.ticker,
            start=start,
            end=end,
        )
